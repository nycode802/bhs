...
<DOCTYPE HTML>
    ...
    <DIV class="post_container" style="<?php echo $bgStyle;?> text-align: center;">
        <form method="post" action="admin/admin_edit_page.php">
            <h3>Page Name</h3>
            <input type="text" name="page_name" value="<?php echo $title;?>" />
            <br><Br>
            <h3>Page Content</h3>
            <textarea cols="40" rows="10" name="page_content"><?php echo $content; ?></textarea>
            <input type="hidden" name="id" value="<?php echo $pageID; ?>" />
            <br><br><input type="submit" value="Edit Page" />
        </form>
    </DIV>
    </BODY>
    </HTML>
